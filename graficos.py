...
dados = pd.read_json("relatorio/dados.json")
...
plt.grid(True)
output_file = "relatorio/graphic/mediaTaxa_por_maxbits_grafico.png"
...
plt.grid(True)
output_file = "relatorio/graphic/mediaTempo_por_maxbits_grafico.png"
plt.savefig(output_file)
...
plt.grid(True)
output_file = "relatorio/graphic/mediaDicionario_por_maxbits_grafico.png"
plt.savefig(output_file)
...
plt.grid(True)
output_file = "relatorio/graphic/comp_vs_desc_grafico.png"
plt.savefig(output_file)
...
plt.ylabel('Tempo (ms)')
output_file = "relatorio/graphic/tempo_espaco_grafico.png"
plt.savefig(output_file)
